...
![4X4 identity matrix](https://i.imgur.com/P7BErNU.png)

The inverse of a matrix can be found using this formula:

![formula](https://i.imgur.com/Lt1dU36.png)
...
det(A) is the determinant of matrix A, and CT is the matrix consisting of cofactors of all elements of the matrix A transposed along the main diagonal. The inverse matrix can’t be found if det(A) equals zero. You can look up a calculation example.
